...
class DiveCenterVerificationController extends Controller
{
    private $authUserId;
    ...
    {
        $diveCenter = ManageDiveCenter::find($request->website_id);
    ...
    public function delete(Request $request)
    {
        ...
        $path = public_path() . '/assets/images/scubaya/merchant/website/documents/diveCenter-' . $request->detail_id;
    ...
    */
    ...
    {
        $path = public_path() . '/assets/images/scubaya/website/documents/diveCenter-' . $details->id . '/';
    ...
    {
        $path = public_path() . '/assets/images/scubaya/website/documents/diveCenter-'.$details->id .'/'.$details->id.'-'.$file;
        File::delete($path);
    }
}
