...
namespace App\Http\Controllers\Merchant\Hotel;
...
class HotelVerificationController extends Controller
{
    private $authUserId;
    ...
    {
        $hotel = Hotel::find($request->website_id);
    ...
    public function delete(Request $request)
    {
        ...
        $path = public_path() . '/assets/images/scubaya/merchant/website/documents/hotel-' . $request->detail_id;
    ...
    */
    ...
    {
        $path = public_path() . '/assets/images/scubaya/website/documents/hotel-' .$details->id. '/';
    ...
    {
        $path = public_path() . '/assets/images/scubaya/website/documents/hotel-' .$details->id. '/' . $details->id . '-' . $file;
        File::delete($path);
    }
}
