...
@section('breadcrumb')
    ...
    <li class="active"><span>{{ $location->name }}</span></li>
@endsection
...
@section('content')
    ...
    <section id="create_location_section" class="padding-20">
        <div class="box box-primary">
            ...
            @endif
            <form role="form" enctype="multipart/form-data" method="post" action="{{ route('scubaya::merchant::dive_center::edit_location', [Auth::id(),$location->id]) }}">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="btn-group" data-toggle="buttons">
                                    <label class="btn btn-default btn-on btn-sm @if($location->active == '1') active  @endif">
                                        <input type="radio" value="1" name="active" @if($location->active == '1') checked @endif>Yes</label>

                                    <label class="btn btn-default btn-off btn-sm @if($location->active == '0') active @endif">
                                        <input type="radio" value="0" name="active" @if($location->active == '0') checked @endif>No</label>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="name" class="control-label" data-toggle="tooltip" title="Name Of Location">Name*</label>
                                <input type="text" id="name" name="name" class="form-control" value="{{ $location->name }}" placeholder="Enter name">
                            </div>

                            <div class="form-group">
                                <label for="longitude" class="control-label" data-toggle="tooltip">Longitude*</label>
                                <input type="text" id="longitude" name="longitude" class="form-control" value="{{$location->longitude}}" placeholder="Longitude">
                            </div>

                            <div class="form-group">
                                <label for="latitude" class="control-label" data-toggle="tooltip">Latitude*</label>
                                <input type="text" id="latitude" name="latitude" class="form-control" value="{{ $location->latitude }}" placeholder="latitude">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group" data-toggle="buttons">
                                    <label class="btn btn-default btn-on btn-sm @if($location->need_a_boat == '1') active @endif">
                                        <input type="radio" value="1" name="need_a_boat" @if($location->need_a_boat === '1') checked @endif>Yes</label>

                                    <label class="btn btn-default btn-off btn-sm @if($location->need_a_boat == '0') active @endif">
                                        <input type="radio" value="0" name="need_a_boat" @if($location->need_a_boat == '0') checked @endif>No</label>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $('#type').selectpicker('val', '{{$location->type}}');
        $('#level').selectpicker('val', '{{$location->level}}');
