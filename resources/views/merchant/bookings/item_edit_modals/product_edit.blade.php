...
<div class="modal fade bs-example-modal-lg" tabindex="-1" id="edit-product-modal{{@$product_checkout_detail->id}}" role="dialog" aria-labelledby="edit" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content padding-20">
            ...
            <div class="modal-body">
                <form name="edit_product_booking" method="post" action="{{ route('scubaya::merchant::bookings::update_product_booking', [$merchantId, $bookingId]) }}">
                    {{ csrf_field() }}
