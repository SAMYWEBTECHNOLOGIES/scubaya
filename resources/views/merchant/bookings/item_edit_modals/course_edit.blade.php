...
<div class="modal fade bs-example-modal-lg" tabindex="-1" id="edit-course-modal{{@$course_checkout_detail->id}}" role="dialog" aria-labelledby="edit" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content padding-20">
            ...
            <div class="modal-body">
                <form name="edit_course_booking" method="post" action="{{ route('scubaya::merchant::bookings::update_course_booking', [$merchantId, $bookingId]) }}">
                    {{ csrf_field() }}
