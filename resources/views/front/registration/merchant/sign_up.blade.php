    ...
    <section id="merchant_sign_up" class="margin-top-60">
        <div class="scubaya-box">
            <div class="scubaya-box-body">
                ...
                <form class="sign_up_form" id="merchant_sign_up_form"  name="sign_up_form" method="post" action="{{ route('scubaya::register::create_merchant') }}">
                    {{csrf_field()}}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-4 pull-right">
                                <div class="form-group">
                                    <a href="{{ route('scubaya::home') }}"><input type="button" class="form-control btn btn-default" id="cancel" name="cancel" value="Cancel"></a>
                                </div>
                            </div>
                            <div class="col-md-4 pull-right">
                                <div class="form-group">
