@php
    $merchantId =   (new \Hashids\Hashids())->encode($hotel_detail->merchant_key);
    $bookingId  =   (new \Hashids\Hashids())->encode($hotel_checkout_detail->id);
@endphp

<div class="modal fade bs-example-modal-lg" tabindex="-1" id="edit-hotel-modal{{@$hotel_checkout_detail->cart_id}}" role="dialog" aria-labelledby="edit" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content padding-20">
            ...
            <div class="modal-body">
                <form name="edit_hotel_booking" method="post" action="{{ route('scubaya::user::bookings::edit_booking', [Auth::id(), $merchantId, $bookingId]) }}">
                    {{ csrf_field() }}
