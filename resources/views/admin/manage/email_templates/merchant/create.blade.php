...
@section('breadcrumb')
    ...
    <li><a href="{{route('scubaya::admin::manage::merchant_email_template')}}">Merchant Email Templates</a></li>
    ...
    <section class="padding-20">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Add Email Template For Merchant</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            @if ($errors->any())
            ...
            <form id="email_template_form" role="form" method="post" action ="{{route('scubaya::admin::manage::add_email_template',['merchant'])}}"
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                @php
                                    $actions = config('email-actions.merchant');
                                @endphp
                    ...
                    <div class="box-footer">
                        <a href="{{ route('scubaya::admin::manage::merchant_email_template') }}">
