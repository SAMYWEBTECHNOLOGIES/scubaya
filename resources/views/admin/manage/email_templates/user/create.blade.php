...
@section('breadcrumb')
    ...
    <li><a href="{{route('scubaya::admin::manage::user_email_template')}}">User Email Templates</a></li>
    ...
    <section class="padding-20">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Add Email Template For User</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            @if ($errors->any())
            ...
            <form id="email_template_form" role="form" method="post" action ="{{route('scubaya::admin::manage::add_email_template',['user'])}}"
