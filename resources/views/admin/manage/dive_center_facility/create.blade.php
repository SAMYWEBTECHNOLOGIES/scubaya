...
@section('breadcrumb')
    ...
    <li class="active"><span>Add Facility</span></li>
@endsection
...
@section('content')
    <section class="container screen-fit">
        <div class="box box-primary container">
            ...
            <form role="form" method="post" action="{{route('scubaya::admin::manage::center_facility::create')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="box-body">
