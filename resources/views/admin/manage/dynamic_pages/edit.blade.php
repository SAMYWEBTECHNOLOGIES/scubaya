...
@section('content')
    <section class="container screen-fit">
        <div class="box box-primary">
            ...
            <form id="dynamic_content_form" role="form" method="post" action="{{route('scubaya::admin::manage::edit_page',[$data->id])}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="dynamic_content" placeholder="Enter the html here" rows="15" name="dynamic_content">{{$data->content}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
