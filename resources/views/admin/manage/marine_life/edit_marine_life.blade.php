...
@section('content')
    <section class="container screen-fit">
        <div class="box box-primary">
            ...
            <form role="form" method="post" action="{{route('scubaya::admin::manage::edit_marine_life',[$id])}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="common_name" name="common_name" value="{{$data->common_name}}">
                            </div>

                            <div class="form-group">
                                <label for="scientific_name" data-toggle="tooltip">Scientific name</label>
                                <input type="text" class="form-control" id="scientific_name" name="scientific_name" value="{{$data->scientific_name}}">
                            </div>
                        ...
                        <div class="col-md-8">
                            <div class="from-group">
                                ...
                                <textarea  rows="8" class="form-control form-group" id="description" placeholder="Description" name="description">{{$data->description}}</textarea>
                            </div>
                        </div>
                    </div>
